...
const PointOfInterest = () => {
  ...
  return (
    <div className="max-w-6xxl mx-auto mt-14">
      ...
      <div className="bg-white h-1/6 md:hidden flex flex-wrap justify-center gap-4 px-4"> {/* Added flex flex-wrap */}
      ...
      <div className="flex">
        ...
        <div className="w-1/6 bg-white flex flex-col justify-top md:flex md:w-1/6 hidden"> {/* Hidden on mobile */}
          <ul className="">
            {categories.map((category) => (
              <li
                key={category}
        ...
        <div className="w-5/6 bg-white p-6 md:pl-6" style={{width: '100%'}}>
          <h3 className="text-xl font-bold mb-4 md:block hidden">{selectedCategory.charAt(0).toUpperCase() + selectedCategory.slice(1)}</h3>

...
const SearchBar = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full mt-8">
      ...
      <div className=" h-80 w-full rounded-3xl bg-white border border-gray-300 flex flex-col ">
        <div className="bg-green-500 w-3/4 h-2/6 ml-auto justify-end flex">
        ...
        <div className="w-3/4 h-4/6 bg-blue-500 flex ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
